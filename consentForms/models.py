...
class GeneralInformation(models.Model):
    ...
    generalPatientSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    generalDoctorUsername = models.CharField(max_length=1000,null=True,blank=True)
    generalDoctorSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    generalWitnessUsername = models.CharField(max_length=1000,null=True,blank=True)
    generalWitnessSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    ...
    generalRepresentativeSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    generalRepresentativeDoctorUsername = models.CharField(max_length=10000,null=True,blank=True)
    generalRepresentativeDoctorSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    generalRepresentativeWitnessUsername = models.CharField(max_length=1000,null=True,blank=True)
    generalRepresentativeWitnessSignatureText = models.CharField(max_length=10000,null=True,blank=True)
...
class  InjectionInformed(models.Model):
    ...
    patientSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    employeeUsername = models.CharField(max_length=1000,null=True,blank=True)
    employeeSignatureText = models.CharField(max_length=10000,null=True,blank=True)
...
class KVKKConsent(models.Model):
    ...
    kvkkPatientSignatureText = models.CharField(max_length=10000,null=True,blank=True)
...
class minorConsent(models.Model):
    ...
    minorPatientSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    minorDoctorUsername = models.CharField(max_length=1000,null=True,blank=True)
    minorDoctorSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    ...
    minorlegalRepresentativeSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    minorinterpreterUsername = models.CharField(max_length=1000,null=True,blank=True)
    minorinterpreterSignatureText = models.CharField(max_length=10000,null=True,blank=True)
...
class PunctureConsent(models.Model):
    ...
    puncturePatientSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    punctureDoctorUsername = models.CharField(max_length=1000,null=True,blank=True)
    punctureDoctorSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    punctureWitnessUsername = models.CharField(max_length=1000,null=True,blank=True)
    punctureWitnessSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    ...
    punctureRepresentativeSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    punctureRepresentativeDoctorUsername = models.CharField(max_length=1000,null=True,blank=True)
    punctureRepresentativeDoctorSignatureText = models.CharField(max_length=10000,null=True,blank=True)
    punctureRepresentativeWitnessUsername = models.CharField(max_length=1000,null=True,blank=True)
    punctureRepresentativeWitnessSignatureText = models.CharField(max_length=10000,null=True,blank=True)
