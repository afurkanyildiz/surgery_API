...
class AmbulanceCase(models.Model):
    ...
    sas_protokol = models.CharField(max_length=1000, blank=True,null=True)
    username = models.CharField(max_length=1000, blank=True,null=True)
    identification_number = models.CharField(max_length=1000,blank=True,null=True,default=None)
    gender = models.CharField(max_length=50,blank=True,null=True)
    age = models.CharField(max_length=1000,blank=True,null=True)
    case_call_clock = models.CharField(max_length=1000,blank=True,null=True)
    case_arrival_time = models.CharField(max_length=1000,blank=True,null=True)
    time_of_leave_from_case = models.CharField(max_length=1000,blank=True,null=True)
    hospital_arrival_time = models.CharField(max_length=1000,blank=True,null=True)
    tel_number = models.CharField(max_length=1000,blank=True,null=True)
    adress = models.CharField(max_length=1000, blank=True,null=True)
    place_from_the_patient = models.CharField(max_length=1000, blank=True,null=True)
    first_place_the_patient_is_transported = models.CharField(max_length=1000, blank=True,null=True)
    second_place_the_patient_is_transported = models.CharField(max_length=1000,blank=True,null=True)
    patients_complaint = models.CharField(max_length=1000,blank=True,null=True)
    prediction = models.CharField(max_length=1000,blank=True,null=True)
    chronic_diseases = models.CharField(max_length=1000,blank=True,null=True)
    explanation_application = models.CharField(max_length=1000,blank=True,null=True)
    isolationStatus = models.CharField(max_length=1000,blank=True,null=True)
    one_measurement = models.CharField(max_length=1000,blank=True,null=True)
    one_blood_pressure = models.CharField(max_length=1000,blank=True,null=True)
    one_pulse = models.CharField(max_length=1000,blank=True,null=True)
    one_spo2 = models.CharField(max_length=1000,blank=True,null=True)
    one_respirations_min = models.CharField(max_length=1000,blank=True,null=True)
    one_fire = models.CharField(max_length=1000,blank=True,null=True)
    second_measurement = models.CharField(max_length=1000,blank=True,null=True)
    second_blood_pressure = models.CharField(max_length=1000,blank=True,null=True)
    second_pulse = models.CharField(max_length=1000,blank=True,null=True)
    second_spo2 = models.CharField(max_length=1000,blank=True,null=True)
    second_respirations_min = models.CharField(max_length=1000,blank=True,null=True)
    second_fire = models.CharField(max_length=1000,blank=True,null=True)
    third_measurement = models.CharField(max_length=1000,blank=True,null=True)
    third_blood_pressure = models.CharField(max_length=1000,blank=True,null=True)
    third_pulse = models.CharField(max_length=1000,blank=True,null=True)
    third_spo2 = models.CharField(max_length=1000,blank=True,null=True)
    third_respirations_min = models.CharField(max_length=1000,blank=True,null=True)
    third_fire = models.CharField(max_length=1000,blank=True,null=True)
    state = models.CharField(max_length=1000, blank=True,null=True)
    pupils = models.CharField(max_length=1000, blank=True,null=True)
    skin = models.CharField(max_length=1000, blank=True,null=True)
    respiratory = models.CharField(max_length=1000, blank=True,null=True)
    pulse = models.CharField(max_length=1000, blank=True,null=True)
    engine_response = models.CharField(max_length=1000, blank=True,null=True)
    oral_response = models.CharField(max_length = 200, blank=True,null=True)
    eyes_open = models.CharField(max_length=1000, blank=True,null=True)
    gks_points = models.CharField(max_length=1000,blank=True,null=True)
    cpr_doing  = models.CharField(max_length=1000,blank=True,null=True)
    start_time = models.CharField(max_length=1000,blank=True,null=True)
    finish_time = models.CharField(max_length=1000,blank=True,null=True)
    reason_to_leave = models.CharField(max_length=1000,blank=True,null=True)
    applicationList = models.CharField(max_length=1000, blank=True,null=True)
    Casetransfer = models.CharField(max_length=1000,blank=True,null=True)
    generalList = models.CharField(max_length=1000,blank=True,null=True)
    number_of_attendants = models.CharField(max_length=1000,blank=True,null=True)
    ambulance_waiting_hour = models.CharField(max_length=1000,blank=True,null=True)
    ambulance_waiting_minute = models.CharField(max_length=1000,blank=True,null=True)
    emergency_ambulance_waiting = models.CharField(max_length=1000,blank=True,null=True)
    emergency_ambulance_waiting_minute = models.CharField(max_length=1000,blank=True,null=True)
    patient_transport_ambulance_waiting = models.CharField(max_length=1000,blank=True,null=True)
    patient_transport_ambulance_waiting_minute = models.CharField(max_length=1000,blank=True,null=True)
    patient_username = models.CharField(max_length=1000, blank=True,null=True)
    patient_signature = models.CharField(max_length=1000, blank=True,null=True)
    hospital_rejection = models.CharField(max_length=1000,blank=True,null=True)
    sigtext = models.CharField(max_length=5000,blank=True,null=True)
    patients_relative_username = models.CharField(max_length=1000, blank=True,null=True)
    ...
    delivery_area_username = models.CharField(max_length=1000,blank=True,null=True)
    delivery_area_signaturetext = models.CharField(max_length=5000,blank=True,null=True)
    doctor_username = models.CharField(max_length=1000, blank=True,null=True)
    doctor_signaturetext = models.CharField(max_length=5000, blank=True,null=True)
    personal_username = models.CharField(max_length=1000,blank=True,null=True)
    personal_signaturetext = models.CharField(max_length=5000,blank=True,null=True)
    pilot_username = models.CharField(max_length=1000,blank=True,null=True)
    pilot_signaturetext = models.CharField(max_length=5000,blank=True,null=True)
    car_info = models.CharField(max_length=1000, blank=True,null=True)
    start_km = models.CharField(max_length=1000,blank=True,null=True)
    finish_km = models.CharField(max_length=1000,blank=True,null=True)
    protocol_number = models.CharField(max_length=1000, blank=True,null=True)
    ...
    doctor_username1 = models.CharField(max_length=1000,blank=True,null=True)
    institution_information = models.CharField(max_length=1000,blank=True,null=True)
    patient_rejection = models.CharField(max_length=1000,blank=True,null=True)
    organization_hour = models.CharField(max_length=1000,blank=True,null=True)
    statetxt = models.CharField(max_length=1000,blank=True,null=True)
    pupilstxt = models.CharField(max_length=1000,blank=True,null=True)
    skintxt = models.CharField(max_length=1000,blank=True,null=True)
    respiratorytxt = models.CharField(max_length=1000,blank=True,null=True)
    pulsetxt = models.CharField(max_length=1000,blank=True,null=True)
...
class CallCenter(models.Model):
    institution_name = models.CharField(max_length=1000, blank=True,null=True)
    caller_username = models.CharField(max_length=1000,blank=True,null=True)
    proximity = models.CharField(max_length=1000,blank=True,null=True)
    caller_tel_no = models.CharField(max_length=1000,blank=True,null=True)
    patient_username = models.CharField(max_length=1000,blank=True,null=True)
    patient_age = models.CharField(max_length=1000,blank=True,null=True)
    gender = models.CharField(max_length=1000,blank=True,null=True)
    patient_adress = models.CharField(max_length=1000,blank=True,null=True)
    patient_for_directions = models.CharField(max_length=1000,blank=True,null=True)
    case_no = models.CharField(max_length=1000,blank=True,null=True)
    case_date = models.CharField(max_length=1000,blank=True,null=True)
    car_info = models.CharField(max_length=1000, blank=True,null=True)
    case_time = models.CharField(max_length=1000,blank=True,null=True)
    alarm_clock = models.CharField(max_length=1000,blank=True,null=True)
    case_yes = models.CharField(max_length=1000,blank=True,null=True)
    appointment_time = models.CharField(max_length=1000,blank=True,null=True)
    appointment_date = models.CharField(max_length=1000,blank=True,null=True)
    patient_complaint = models.CharField(max_length=1000,blank=True,null=True)
    patient_clinic = models.CharField(max_length=1000,blank=True,null=True)
    pre_diagnosis = models.CharField(max_length=1000, blank=True,null=True)
    consent_received_person = models.CharField(max_length=1000,blank=True,null=True)
    triaj = models.CharField(max_length=1000,blank=True,null=True)
    exit_time = models.CharField(max_length=1000,blank=True,null=True)
    output_method = models.CharField(max_length=1000, blank=True,null=True)
    transport_hour = models.CharField(max_length=1000,blank=True,null=True)
    event_exit_time = models.CharField(max_length=1000,blank=True,null=True)
    hospital_arrival_time = models.CharField(max_length=1000,blank=True,null=True)
    time_out_hospital = models.CharField(max_length=1000,blank=True,null=True)
    point_return_time = models.CharField(max_length=1000,blank=True,null=True)
    patient_taken_place = models.CharField(max_length=1000,blank=True,null=True)
    where_patient_first_dropped = models.CharField(max_length=1000,blank=True,null=True)
    patient_last_off_place = models.CharField(max_length=1000,blank=True,null=True)
    ambulance = models.CharField(max_length=1000,blank=True,null=True)
    assurance = models.CharField(max_length=1000,blank=True,null=True)
    paid = models.CharField(max_length=1000,blank=True,null=True)
    free = models.CharField(max_length=1000,blank=True,null=True)
    contracted_institution = models.CharField(max_length=1000,blank=True,null=True)
    discount = models.CharField(max_length=1000,blank=True,null=True)
    protocol_number = models.CharField(max_length=1000,blank=True,null=True)
    ...
    call_domain_username = models.CharField(max_length=1000, blank=True,null=True)
    patient_tel_no = models.CharField(max_length=1000,blank=True,null=True)
